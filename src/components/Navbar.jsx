...
import cooking_logo from "../assets/img/cooking_logo.png";
    ...
    <>
      <nav className="bg-white  dark:bg-gray-900 fixed w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-2">
          ...
          >
            <img src={cooking_logo} className="h-16" alt="cooking Logo" />
            <span className="self-center text-2xl text-amber-900 font-semibold whitespace-nowrap dark:text-white">
              COOK-FAFO
            </span>
          </Link>
